  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDefaultAddress(address, addressInfo)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="goodDetail in orderInfo.detailArrayList"
          :key="goodDetail.skuId"
        >
          <li>
            <img
          ...
          <li>
            <h3>￥{{ goodDetail.orderPrice }}.00</h3>
          </li>
          <li>X{{ goodDetail.skuNum }}</li>
          <li>有货</li>
        </ul>
      </div>
      <div class="bbs">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ currentCheckedAddress.fullAddress }}</span>
        收货人：<span>{{ currentCheckedAddress.consignee }}</span>
        <span>{{ currentCheckedAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      const submitData = {
        consignee: this.currentCheckedAddress.consignee,
        consigneeTel: this.currentCheckedAddress.phoneNum,
        deliveryAddress: this.currentCheckedAddress.fullAddress,
        paymentWay: 'ONLINE',
